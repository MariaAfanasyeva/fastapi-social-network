...
from social_network.tests.helpers import create_comment, create_post, like_post


@pytest.fixture()
def mock_generate_cute_creature_api(mocker):
    return mocker.patch(
        "social_network.tasks._generate_cute_creature_api",
...
async def test_create_post_expired_token(
    ...
    mocker.patch("social_network.security.access_token_expiry_minutes", return_value=-1)
